...
export const business = {
  ...
  // Из брифа. На Zoon в описании указано «открыт с 1996 года» — уточнить у владельца.
  since: 2007,
  clients: "7000+",
  brandsCount: "40+",
  // Из брифа. На Zoon общий рейтинг 4,9 (3177 оценок); отзывы 2026 года: 48 из 50 — на «5».
  rating: "5,0",
